...
void testInputReadFromFile() {
    ...
    for (auto FileName : InputFilenames) {
        ...
        InputReadFromFile(id, FileName, SimulationType, AConst, BConst, CConst, DConst, FreezingRange, deltax, NMax,
                          dTN, dTsigma, OutputFile, GrainOrientationFile, TempFilesInSeries, temp_paths, HT_deltax,
                          RemeltingYN, deltat, NumberOfLayers, LayerHeight, SubstrateFileName, SubstrateGrainSpacing,
