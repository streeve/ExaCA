...
void RunProgram_Reduced(int id, int np, std::string InputFile) {
    ...
    // Read input data
    InputReadFromFile(id, InputFile, SimulationType, AConst, BConst, CConst, DConst, FreezingRange, deltax, NMax, dTN,
                      dTsigma, OutputFile, GrainOrientationFile, TempFilesInSeries, temp_paths, HT_deltax, RemeltingYN,
                      deltat, NumberOfLayers, LayerHeight, SubstrateFileName, SubstrateGrainSpacing, UseSubstrateFile,
                      G, R, nx, ny, nz, FractSurfaceSitesActive, PathToOutput, PrintDebug, PrintMisorientation,
    ...
    if (RemeltingYN) {
        ...
        if (SimulationType == "R")
            TempInit_ReadDataRemelt(0, id, nx, MyYSlices, nz, LocalActiveDomainSize, LocalDomainSize, MyYOffset, deltax,
                                    deltat, FreezingRange, LayerTimeTempHistory, NumberOfSolidificationEvents,
            ...
            TempInit_SpotRemelt(0, G, R, SimulationType, id, nx, MyYSlices, MyYOffset, deltax, deltat, ZBound_Low, nz,
                                ...
                                UndercoolingCurrent, LayerHeight, FreezingRange, LayerID, NSpotsX, NSpotsY, SpotRadius,
        ...
        if (SimulationType == "R")
            TempInit_ReadDataNoRemelt(id, nx, MyYSlices, MyYOffset, deltax, HTtoCAratio, deltat, nz, LocalDomainSize,
                                      ...
                                      LayerHeight, NumberOfLayers, FinishTimeStep, FreezingRange, LayerID, FirstValue,
                                      LastValue, RawData);
        else if (SimulationType == "S")
            ...
            if (RemeltingYN) {
                ...
                if (SimulationType == "S")
                    TempInit_SpotRemelt(layernumber + 1, G, R, SimulationType, id, nx, MyYSlices, MyYOffset, deltax,
                                        ...
                                        UndercoolingChange, UndercoolingCurrent, LayerHeight, FreezingRange, LayerID,
                    ...
                    TempInit_ReadDataRemelt(
                        ...
                        deltax, deltat, FreezingRange, LayerTimeTempHistory, NumberOfSolidificationEvents,
    ...
    PrintExaCALog(id, np, InputFile, SimulationType, MyYSlices, MyYOffset, AConst, BConst, CConst, DConst,
                  FreezingRange, deltax, NMax, dTN, dTsigma, temp_paths, TempFilesInSeries, HT_deltax, RemeltingYN,
